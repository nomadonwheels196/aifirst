...
## Purpose
This folder organizes materials for Business Operations — finance/Accounting/Revenue_Recognition/ASC_606. Focus: accounting policies, close, AP/AR, payroll.
...
## Primary Owner
- Role: Accounting (role-based)
- Review cadence: monthly/quarterly
- Approval: when changes require legal/security review


## Contributors
- Roles/Teams: Accounting, Finance
- Change process: PR with Accounting review
