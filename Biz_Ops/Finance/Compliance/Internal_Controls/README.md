...
## Purpose
This folder organizes materials for Business Operations — finance/Compliance/Internal_Controls. Focus: controls, audits, certifications.
...
## Outputs
<Artifacts produced: docs, templates, runbooks>


## Primary Owner
- Role: Compliance (role-based)
- Review cadence: quarterly
- Approval: when control/policy changes


## Contributors
- Roles/Teams: Compliance, Security
- Change process: PR with Compliance review
