...
CLI Calculator
- Use `Biz_Ops/Structure_Analysis/Spain/royalty_tax_calculator.py` to vary inputs.
- Examples:
  - `python3 Biz_Ops/Structure_Analysis/Spain/royalty_tax_calculator.py`
  - `python3 Biz_Ops/Structure_Analysis/Spain/royalty_tax_calculator.py --royalty 8000000 --wht-us 0.05 --wht-ie 0.00 --wht-cayman 0.24 --ie-rate 0.125 --gilti-rate 0.105`
