...
## Purpose
This folder organizes materials for Business Operations — finance/Billing/Integrations/Stripe. Focus: finance processes, models, and policies.
...
## Primary Owner
- Role: Finance (role-based)
- Review cadence: monthly/quarterly
- Approval: when changes require legal/security review


## Contributors
- Roles/Teams: Finance, Operations
- Change process: PR with Finance review
