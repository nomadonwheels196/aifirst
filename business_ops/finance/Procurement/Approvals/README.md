...
## Purpose
This folder organizes materials for Business Operations — finance/Procurement/Approvals. Focus: vendor onboarding and approvals.
...
## Primary Owner
- Role: Procurement (role-based)
- Review cadence: quarterly
- Approval: when vendor policy changes


## Contributors
- Roles/Teams: Procurement, Finance
- Change process: PR with Procurement review
