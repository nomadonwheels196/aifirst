...
## Purpose
This folder organizes materials for Business Operations — legal/Investor_Relations. Treat contents as sensitive; reference documents without duplicating.
...
## Related
- Investor Side Letter - Voting Covenant template.md (Investor Side Letter - Voting Covenant template.md)
