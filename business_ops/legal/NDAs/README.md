...
## Purpose
This folder organizes materials for Business Operations — legal/NDAs. Treat contents as sensitive; reference documents without duplicating.
...
## Related
- Mutual Non-Disclosure Agreement (Pre-Incorporation).md (Mutual Non-Disclosure Agreement (Pre-Incorporation).md)
- One-Way NDA - Employment Candidates (Pre-Incorporation).md (One-Way NDA - Employment Candidates (Pre-Incorporation).md)
