...
## Purpose
This folder organizes materials for Business Operations — legal/Tax. Treat contents as sensitive; reference documents without duplicating.
...
## Related
- Spain - Pre‑Incorporation Expenses and IVA.md (Spain - Pre‑Incorporation Expenses and IVA.md)
