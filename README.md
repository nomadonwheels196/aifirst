...
- **[Company Specs](business_spec/)** - Mission, strategy, framework (source of truth)
- **[Examples & Case Studies](examples/)** - Real implementations demonstrating our approach
- **[Product Documentation](product_management/)** - MVP specs, research, use cases
...
This is a living repository. As we learn and grow:
...
- Read: [CLAUDE.md](CLAUDE.md) for working with this repo
- Ask: @travis on Slack
- Check: [Guiding Principles](business_spec/Guiding%20Principles%20.md) for decision-making framework
